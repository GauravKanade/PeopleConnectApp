...
public class GetComplains extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String str5 = "SELECT CITY_ID, STATE_ID FROM USERS WHERE USER_ID=?";
            ...
            String state_id = "0";
            while(rs5.next()){
                city_id = rs5.getString("CITY_ID");
                state_id = rs5.getString("STATE_ID");
            }

            String str1 = "SELECT * FROM COMPLAINTS WHERE CITY_ID=? AND STATE_ID=? ORDER BY COMPLAINED_ON DESC";
            PreparedStatement prep1 = con.prepareStatement(str1);
            prep1.setString(1, city_id);
            prep1.setString(2, state_id);
